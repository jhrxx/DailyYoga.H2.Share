...
<?php
	...
	if($id) {
			...
			$url = 'http://192.168.200.168/yoga/session/getDetailInfo?type=2&sessionId='.$id.'&debug=1';
		...
		?>
			...
			<div class="index3">
				<table width="100%">
					...
					<tr>
						<td align="center">
							<h3 style="margin-top:20px;color:#333333;"><?php echo $title;?></h3>
						</td>
					</tr>
					<tr>
						<td id="content_desc" style="padding:1.5em;">
							<?php echo $desc;?>
						</td>
					</tr>
				</table>
...
$(document).ready(function(e) {
	...
	//代替alert命令
	//alertFunc('测试测试');
	var haha=$("#content_desc").val();
	var haha2=haha.replace('<br/>','/n');
	$("#content_desc").val(haha2);
