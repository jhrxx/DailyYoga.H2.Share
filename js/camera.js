...
$(document).ready(function(e) {	
	...
	function init(){
		fileBox=$('<div id="fileBox"><input type="file" accept="image/jpeg" name="fileInput"/></div>').appendTo(htmlBox);
	...
	function imgBtnCf_click(e){
		if(imgStep==1){//第一步,调整刚刚拍摄或者打开的图片
			imgStep++;
			imgSend();
		}//end if
		else if(imgStep==2){//第二步，比如选择一个产品加入画布
			imgStep++;
		}//end else
		else{//第三步，比如在画布里填写祝福文字
		}//end else
	}//end func
